...
export default function Footer() {
  ...
  return (
    <Box
      ...
      className="text-center border-t py-5"
    >
      <Container maxWidth="xl" className="flex flex-col gap-4">
        ...
        {/* Copyright*/}
        <Box borderColor="secondary.contrastText" className="text-center border-t pt-4">
          <Typography component="p" color="secondary.contrastText" className="footer-copy">
            Copyright © 2025{" "}
            <MUILink
